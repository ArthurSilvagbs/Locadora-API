...
public class LocacaoService {
   ...
   @Transactional
   public LocacaoResponseDTO criarReservaDaCategoriaDeVeiculo(LocacaoCreateDTO dto) {
      ...
      Locacao locacao = mapper.mapearParaLocacao(
         dto,
         cliente,
         filialRetirada,
         filialDevolucao,
   ...
   public LocacaoResponseDTO confirmarRetirada(ConfirmarRetiradaDTO dto, String idLocacao) {
      ...
      Veiculo veiculo = veiculoRepository.findById(UUID.fromString(dto.idVeiculo()))
      ...
      if (veiculo.getStatusVeiculo() != StatusVeiculo.DISPONIVEL) {
         throw new StatusInvalidoException("O veículo não estao disponível para retirada.");
      }
